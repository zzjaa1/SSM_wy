...
;layui.define("jquery", function (e) {
    ...
    r.prototype.init = function (e) {
        ...
        o.options.skin && e.addClass("layui-tree-skin-" + o.options.skin), o.tree(e), o.on(e)
        ...
        layui.each(n, function (a, n) {
            ...
            l && (s.append(c), i.tree(c, n.children)), e.append(s),
            "function" == typeof r.click && i.click(s, n), i.spread(s, n), r.drag && i.drag(s, n)
        })
    },
