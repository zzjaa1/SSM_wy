...
<head>
    ...
    <link rel="stylesheet" href="../../css/property_charge_repair.css">
</head>
<body>
<!--头部-->
    <header>
...
<!--页面左侧-->
    ...
    <div class="con_head" id="con_head">
        <em><img src="../../images/wy.png" alt=""></em><a href="#">物业管理</a><span>></span><a href="#">报修</a><span>></span><a href="#">报修收费项目维护</a>
    </div>
        ...
        <div class="con_right">
            <div>
                <div class="con_right_box" style="display:block;">
                    <div class="cr_con">
                        <div class="crc_head">
                            <em><img src="../../images/qb.png" alt=""></em>报修收费项目列表
                            <a href="#" id="bt" class="cr_a" style="margin-top: 2px;background-color: #00a0e9;border-radius: 0">新增收费项目</a>
                        </div>
                        <div>
                            <table class="cr_table">
                                <tr class="t_head">
                                    <td style="width: 250px;">小区</td>
                                    <td style="width: 350px;">收费项目名称</td>
                                    <td style="width: 100px;">收费金额</td>
                                    <td style="width: 150px;">添加人</td>
                                    <td style="width: 350px;">添加日期</td>
...
<div class="login" id="login">
    ...
    <div class="login_box">
        <p style="margin-top: 0">
            <lable for="ipt1">收费项目名称：</lable>
            <input type="text" class="cr_ipt1" id="ipt1" placeholder="收费项目名称">
        </p>
        <p>
            <lable for="ipt2">收费金额：</lable>
            <input type="text" class="cr_ipt1" id="ipt2" placeholder="收费金额" style="margin-left:40px ">
        </p>
        <button id="btclose2">增加</button>
    </div>
</div>
    ...
    <script>
        ...
        /*删除效果*/
        $('.cr_table button').click(function () {
